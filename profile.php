...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('profile.jpg'); /* Replace with your image path */
...
<body class="flex items-center justify-center min-h-screen text-white">
    <div class="bg-gray-900 p-8 rounded-xl shadow-2xl max-w-md w-full">
        <h1 class="text-3xl font-bold text-center text-blue-400 mb-6">User Profile</h1>
        ...
        <form action="./profile.php" method="POST" class="space-y-6">
            <div>
                ...
                <input type="text" id="username" name="username" required
                       ...
                       class="mt-2 w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition duration-200 placeholder-gray-400">
            </div>
        ...
        <div class="mt-6 text-center">
            <a href="./my_dashboard.php" class="text-gray-400 hover:text-blue-400 transition duration-200">Back to user Dashboard</a>
        </div>
    </div>
</body>
</html>
